...
@interface USHCustomComboBoxTableCell ()

@end

@implementation USHCustomComboBoxTableCell
...
- (void) setChecked:(BOOL)isChecked {
	if (isChecked) {
		...
		[self.checkBox setImage:[UIImage imageNamed:@"done.png"] forState:UIControlStateNormal];
	}
}
